...
if __name__ == "__main__":
    ...
    license_plate_detector = YOLO(r"C:\Users\User\Downloads\license_plate_detector.pt")
    print("License plate detector model loaded.")

    # load video
    cap = cv2.VideoCapture(r"C:\Users\User\Desktop\soham\lpr\sample.mp4")

    # vehicles in COCO dataset
    vehicles = [2, 3, 5, 7]
